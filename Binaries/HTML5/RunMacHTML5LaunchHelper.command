...
if [ -f "g:\Program Files\Epic Games\UE_4.15\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "g:\Program Files\Epic Games\UE_4.15\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
